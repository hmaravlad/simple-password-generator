...
export class Top1000000PasswordBlock implements Block {
  type = BlockType.Text;
  ...
  constructor() {
    ...
    this.passwords = strFileParser.parse('./src/common-credentials/10-million-password-list-top-1000000.txt');
  }
